...
void YMCV_GrayConvFker_3X3(const float32* mykernel, CVIMAGE myimg, uint8* outp);//3*3滤波核滤波 含越界自适应处理
void YMCV_GrayConvIker_3X3(const int16* mykernel, CVIMAGE myimg, uint8* outp);//3*3滤波核滤波 越界则输出为0
//分离加速
