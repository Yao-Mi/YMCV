...
//RGB565提取三通道(假设最大值统一为255，这里要添加缺省补偿项)
#define  RGB565GET_R(rgb565)   (((rgb565 & 0xF800) >> 8)|0x07)
#define  RGB565GET_G(rgb565)   (((rgb565 & 0x07E0) >> 3)|0x03)
#define  RGB565GET_B(rgb565)   (((rgb565 & 0x001F) << 3)|0x07)

//三通道转RGB565
#define  R_TORGB565(R)   ((((CVrgb16)R) << 8) & 0xF800)
#define  G_TORGB565(G)   ((((CVrgb16)G) << 3) & 0x07E0)
...
/**
  ...
  */
static inline void YMCV_Rgb565ToRgb_3(CVrgb16 rgb565, _color8_t* R, _color8_t* G, _color8_t* B)
{
...
/**
  ...
  */
static inline void YMCV_Rgb565ToRgb24(CVrgb16 rgb565, CVRGB24 RGB)
{
...
/**
  ...
  */
static inline CVrgb16 YMCV_Rgb3ToRgb565(_color8_t R, _color8_t G, _color8_t B)
{
...
/**
  ...
  */
static inline CVgray YMCV_Rgb3ToGray(_color8_t R, _color8_t G, _color8_t B)
{
...
/**
  ...
  */
static inline CVrgb16 YMCV_GrayToRgb565(CVgray gray)
{
...
/**
  ...
  */
static inline CVgray YMCV_Rgb565ToGray(CVrgb16 rgb565)
{
...
/**
  ...
  */
static inline void YMCV_Rgb565ToLAB(CVrgb16 rgb565, int16* L, int16* A, int16* B)
{
	uint32 r, g, b, x, y, z;
	//提取三通道
...
/**
  ...
  */
static inline void YMCV_LABToRgb565(CVrgb16* rgb565, int16 L, int16 A, int16 B)
{
...
/**
  ...
  */
static inline void YMCV_Rgb565ToYCbCr(CVrgb16 rgb565, int16* Y, int16* Cb, int16* Cr)
{
	int32 r, g, b;
	//提取三通道
	r = (int32)RGB565GET_R(rgb565);
	g = (int32)RGB565GET_G(rgb565);
	b = (int32)RGB565GET_B(rgb565);
	//转xyz  Y取值范围:[0,255]
...
/**
  ...
  */
static inline void YMCV_YCbCrToRgb565( CVrgb16* rgb565,int16 Y, int16 Cb, int16 Cr)
{
	int32 r, g, b;
	r = Y + ((2871 * (Cr - 128)) >> 11);
...
/**
  ...
  */
static inline CVgray YMCV_GrayToBinary(CVgray gray, CVgray threshold)
{
...
/**
  ...
  */
static inline CVgray YMCV_GrayToBinary_2Threshold_255(CVgray gray, CVgray leftthresh, CVgray rightthresh)
{
...
/**
  ...
  */
static inline uint8 YMCV_GrayToBinary_2Threshold_1(short gray, short thresholdmin, short thresholdmax)
{
