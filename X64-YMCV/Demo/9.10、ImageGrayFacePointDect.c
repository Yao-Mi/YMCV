...
int main()
{
    ...
    CVVECTORS_U16 result = YMCV_HaarCascade_Detect_Objects(myImage0, &facedect, 0.2f);
    ...
    for (int i = 0; (result != NULL) && (i < result->dataNum); i++)
    {
        ...
        CVVECTORS_U16 facepts = YMCV_FacePoint_Detect_Objects(myImage0, &facepoint_dect, recp, 9,100);
