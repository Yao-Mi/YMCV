...
int main()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        //信息显示
        sprintf(myInform, "gama增强 R: c=%03.2f gama= %01.3f  .  ", myParam.rgb_gama_enhance.R_c, myParam.rgb_gama_enhance.R_gama);
        LCD_ShowString(100, 300, myInform);
        sprintf(myInform, "gama增强 G: c=%03.2f gama= %01.3f  .  ", myParam.rgb_gama_enhance.G_c, myParam.rgb_gama_enhance.G_gama);
        LCD_ShowString(100, 320, myInform);
        sprintf(myInform, "gama增强 B: c=%03.2f gama= %01.3f  .  ", myParam.rgb_gama_enhance.B_c, myParam.rgb_gama_enhance.B_gama);
    ...
    for (int i = 0; i < 20; i++)
    {
        ...
        //信息显示
        sprintf(myInform, "S曲线增强 R: m = %03.2f  E = %02.2f .  ", myParam1.rgb_scurve_enhance.R_m, myParam1.rgb_scurve_enhance.R_E);
        LCD_ShowString(100, 300, myInform);
        sprintf(myInform, "S曲线增强 G: m = %03.2f  E = %02.2f .  ", myParam1.rgb_scurve_enhance.G_m, myParam1.rgb_scurve_enhance.G_E);
        LCD_ShowString(100, 320, myInform);
        sprintf(myInform, "S曲线增强 B: m = %03.2f  E = %02.2f .  ", myParam1.rgb_scurve_enhance.B_m, myParam1.rgb_scurve_enhance.B_E);
        LCD_ShowString(100, 340, myInform);
        //暂停
        PAUSE();
