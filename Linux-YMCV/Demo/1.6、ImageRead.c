...
int main()
{
    ...
    CVIMAGE myImage1 = YMCV_Image_Read( "../../图片素材/xgmm01.jpg", CVRgb16Type);
    CVIMAGE myImage0 = YMCV_Image_Read("../../图片素材/xgmm01.jpg", CVGrayType);
    ...
    myImage1 = YMCV_Image_Read("../../图片素材/linglong_00.bmp", CVRgb16Type);
    myImage0 = YMCV_Image_Read("../../图片素材/linglong_00.bmp", CVGrayType);
    ...
    gd_GIF* mygif = gd_prepare_from_file("../../图片素材/jntm.gif");
    //将解析器画布映射为图像
    CVimage gifimg;
    ...
    /*----------------------------------- avi解码 ------------------------------------------*/
    //打开avi文件，读取文件信息
    avi_t* myavi = AVI_open_input_file("../../图片素材/ymtec.avi", 1);
    //创建显示的图像
