...
/**
  ...
  */
_CV_STATIC inline void YMCV_Rgb565ToRgb_3(CVrgb16 rgb565, _color8_t* R, _color8_t* G, _color8_t* B)
{
...
/**
  ...
  */
_CV_STATIC inline void YMCV_Rgb565ToRgb24(CVrgb16 rgb565, CVRGB24 RGB)
{
...
/**
  ...
  */
_CV_STATIC inline CVrgb16 YMCV_Rgb3ToRgb565(_color8_t R, _color8_t G, _color8_t B)
{
...
/**
  ...
  */
_CV_STATIC inline CVgray YMCV_Rgb3ToGray(_color8_t R, _color8_t G, _color8_t B)
{
...
/**
  ...
  */
_CV_STATIC inline CVrgb16 YMCV_GrayToRgb565(CVgray gray)
{
...
/**
  ...
  */
_CV_STATIC inline CVgray YMCV_Rgb565ToGray(CVrgb16 rgb565)
{
...
/**
  ...
  */
_CV_STATIC inline void YMCV_Rgb565ToLAB(CVrgb16 rgb565, int16* L, int16* A, int16* B)
{
	uint32 r, g, b, x, y, z;
	//提取三通道
...
/**
  ...
  */
_CV_STATIC inline void YMCV_LABToRgb565(CVrgb16* rgb565, int16 L, int16 A, int16 B)
{
...
/**
  ...
  */
_CV_STATIC inline void YMCV_Rgb565ToYCbCr(CVrgb16 rgb565, int16* Y, int16* Cb, int16* Cr)
{
	uint32 r, g, b;
	//提取三通道
	r = (uint32)RGB565GET_R(rgb565);
...
/**
  ...
  */
_CV_STATIC inline void YMCV_YCbCrToRgb565( CVrgb16* rgb565,int16 Y, int16 Cb, int16 Cr)
{
	int32 r, g, b;
	r = Y + ((2871 * (Cr - 128)) >> 11);
...
/**
  ...
  */
_CV_STATIC inline CVgray YMCV_GrayToBinary(CVgray gray, CVgray threshold)
{
...
/**
  ...
  */
_CV_STATIC inline CVgray YMCV_GrayToBinary_2Threshold_255(CVgray gray, CVgray leftthresh, CVgray rightthresh)
{
...
/**
  ...
  */
_CV_STATIC inline uint8 YMCV_GrayToBinary_2Threshold_1(short gray, short thresholdmin, short thresholdmax)
{
